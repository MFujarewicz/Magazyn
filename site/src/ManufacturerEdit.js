        ...
        if (!this.state.ready) {
            ...
            return (
                ...
                <div className="Objects">
                    ...
                    <button type="button" className="add_button" onClick={this.addButton}>Dodaj nowego producenta</button>
...
function ManufacturerList(props) {
    ...
    for (var manufacturer of props.json.manufacturers) {
        manufacturer_info.push(
            <div className="SingleObject" key={manufacturer.ID}>
                Nazwa producenta: {manufacturer.name} <button id={manufacturer.ID} type="button" className="edit_button" onClick={e => props.callback(e.target.id)}>Edytuj</button>
            </div>
        );
    }
